...
WHERE gl.claim_number = @Id
	AND CONVERT(DATETIME, CONVERT(DATETIMEOFFSET(4),q.registration_date) AT TIME ZONE 'FLE Standard Time') BETWEEN DATEADD(hour, -6, gl.registration_date)  AND gl.registration_date
