...
[ADDRESS] NVARCHAR(500), Content NVARCHAR(MAX), QuestionNumber NVARCHAR(20));
...
SELECT
	...
	(Id, EnterNumber, RegistrationDate, Applicant, [ADDRESS], Content, QuestionNumber
	)

	EXEC(@exec); 

	SELECT Id, EnterNumber, RegistrationDate, Applicant, [ADDRESS], Content, QuestionNumber
	FROM #temp_main
    #sort_columns#
