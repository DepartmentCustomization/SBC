...
delete from #temp_RatingPlace
		...
		select Id, case when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 1 then 1
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 2 then 2
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 3 then 3
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 4 then 4
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 5 then 5
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 6 then 6
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 7 then 7
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 8 then 8
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 9 then 9
						when RANK() OVER(PARTITION BY QuestionTypeId, RatingId ORDER BY Inticator_Fact) = 10 then 10
				end
