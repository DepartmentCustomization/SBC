        ...
        customConfig:
                `
                    <style>
                        ...
                        <div ="" class="header-label"> Демо-Розсилка</div>
                    <section ="" class="group-btns">
                      <!-- -->
                      
                      
                      <div ="" class="group" tabindex="0" onclick="javascript:window.location='` + location.origin + localStorage.getItem('VirtualPath') + `/sections/ServiceNotification_ServiceTypesTexts_ToSend'">
                        <div ="" class="icon">
                          <i ="" class="material-icons" style="color:#ff7961;"> location_city </i>
                        </div>
                        <div ="" class="description"> Шаблони управління підписками </div>
