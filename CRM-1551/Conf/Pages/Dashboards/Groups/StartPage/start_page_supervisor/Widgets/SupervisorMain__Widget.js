(function () {
  return {  
    ...
    load: function(data) {
        ...
        let groupSearchAppeals = this.createElement('div', { className: "group", tabindex: '0' }, groupSearchAppeals__icon, groupSearchAppeals__description, groupSearchAppeals__borderBottom, groupSearchAppeals__borderRight );
