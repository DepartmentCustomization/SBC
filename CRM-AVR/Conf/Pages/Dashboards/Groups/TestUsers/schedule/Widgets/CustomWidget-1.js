  ...
  return {
    ...
    load: function(data) {
        ...
        for( let i = 0; i < data.rows.length; i++ ){        
            ...
            const monthOption  = this.createElement('option', {label: ''+item.values[1]+'', value: ''+item.values[0]+'',   className: 'monthOption',});
    ...
    setThisDate: function(message){
        ...
        const val = ''+myMonth+' 01 '+this.year+'';
        ...
        function extractStartDate(val) {
            ...
            var mm = inMonth.getMonth(val)+1; //January is 0!
        ...
        function extractEndDate(val) {
            ...
            inMonth.setDate(-0);
            var dd = inMonth.getDate()-0;
            var mm = inMonth.getMonth()+1;
            var yyyy = inMonth.getFullYear();
