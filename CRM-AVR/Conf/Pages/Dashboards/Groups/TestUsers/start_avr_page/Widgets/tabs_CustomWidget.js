        ...
        afterViewInit: function() {
            ...
            const btn_schedule = this.createElement('button',
                {
                    ...
                    url: 'TablingPerson',
                    location: 'dashboard',
                    innerText: 'Табель поточного місяця'
                }
            );
            const btn_createAppeal = this.createElement('button',
                {
                    id: 'btn_maps',
                    className: 'btn',
                    url: 'Claims/add',
            ...
            btn_schedule.addEventListener('click', event => {
                ...
                window.open(
                    ...
                    target.location + '/page/' + target.url + '?' + params
                );
            });
            ...
            btn_clearFilter.addEventListener('click', () => {
