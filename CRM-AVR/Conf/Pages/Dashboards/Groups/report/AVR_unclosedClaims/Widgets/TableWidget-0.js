    ...
    return {
        ...
        executeSql:function(message) {
            ...
            let executeQuery = {
                ...
                parameterValues: [{key: '@start_date', value: checkDateFrom(message.package.value.values[2].value) },{key: '@finish_date', value: checkDateTo(message.package.value.values[2].value)} ],
                filterColumns: [{
        		key:'Claim_class_ID',
        		value: {
        			operation: 6,
        			not: false,
        			values: extractClaimValues(message.package.value.values[1].value)
        		}
        	},
        	{
