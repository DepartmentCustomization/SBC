(function() {
    return {
        ...
        init: function() {
            let self = this;
            function func() {
                let jsId = 'myJS'; // you could encode the css path itself to generate id..
        ...
        load: function(data) {
            ...
            for (var i = 0; i < data.rows.length; i++) {
                ...
                let contentString1 = '<div id="infowindow_marker01' + i.toString() + '" style="display: flex; max-height: 255px; width:100%;">' +
