  ...
  #calendar {
   /* max-width: 900px;
    ...
    position: sticky;
            ...
            .mainBlockForCard_Rows.typeBlue{
                 border-top: 4px solid #1976d2;
            }
...
setTimeout(func, 100);
  ...
  console.log(data);
        let arrayOfTypes = ['typeOrange','typeGreen', 'typeRed', 'typeBlue', 'typeBlack'];
          ...
          for( let i = 0; i < data.rows.length; i++ ) {
                ...
                //debugger;
                  if(data.rows[i].values[12] != null){
                      ...
                      this.bottomBodyIconItem = this.createElements('i',{className: 'material-icons domain'},'domain');
                 ...
                 //debugger;
                  ...
                  const bottomBodyCentralSide = this.createElements('span',{className: `bottomBodyCentralSide`}, ' '+data.rows[i].values[18]); //organization_name
                  const bottomBodyLeftSide = this.createElements('span',{className: 'bottomBodyLeftSide'}, this.bottomBodyIconItem, bottomBodyTextItem, bottomBodyCentralSide);
                  const bottomBodyRightSide = this.createElements('span',{className: `bottomBodyRightSide ${data.rows[i].values[5]}`}, data.rows[i].values[4]+''); //'0%'
                  ...
                  if(data.rows[i].values[15] != 'ispoln' && data.rows[i].values[15] != 'both'){mainBlockForCard.style.display = 'none';}
    ...
    getViewCard: function(data){
        ...
        if (data.name == "showTaskRow") {
            ...
            document.getElementById('btn_block_appointedTask').classList.remove('display_none');
            ...
            document.getElementsByClassName('ticket')[0].style.display = '';
             ...
             for (var i=0;i<document.getElementsByClassName('mainBlockForCard').length;i++){
        ...
        if (data.name == "showTaskTable") {
            ...
            document.getElementsByClassName('ticket')[0].style.display = '';
             ...
             for (var i2=0;i2<document.getElementsByClassName('mainBlockForCard').length;i2++){
        ...
        if (data.name == "showCalendar") {
            ...
            document.getElementById('btn_block_appointedTask').classList.add('display_none');
