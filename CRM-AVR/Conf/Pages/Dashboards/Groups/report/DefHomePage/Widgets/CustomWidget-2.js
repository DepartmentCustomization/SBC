...
.top-bar .searchbar {
    max-width: 750px
                            ...
                            <div style="    width: 90%;">
                                ...
                                <span id="myTarget1_1" style='color: #a1a1a1; font-size: 1.1em; display: block; padding-left: 17px;'>
                                    ...
                                    <button id="menuBtn_view_map" class="btn2"> <i class="material-icons" id="menuBtn_view_map_Icon" style="color:#cecece;">location_on</i>   </button>
                                     ...
                                     <button id="btn_block_newTask" style="margin-left: 30px; background: #fdbc49; width: 50px; height: 24px; border-radius: 0px; text-align: center; color: #ffffff; cursor: pointer; font-size: 12px;"> НОВІ </button>
                                     <button id="btn_block_appointedTask" style="margin-left: -6px; background: #1976d2; width: 95px; height: 24px; border-radius: 0px; text-align: center; color: #ffffff; cursor: pointer; font-size: 12px;"> РОЗПОДІЛЕНІ</button>
                                     ...
                                     <button id="btn_block_overTask" style="margin-left: -5px; background: #ff5e5e; width: 102px; height: 24px; border-radius: 0px; text-align: center; color: #ffffff; cursor: pointer; font-size: 12px;"> ПРОСТРОЧЕНІ </button>
        ...
        load: function(data) {
            ...
            this.handleButtonGroupClick('showCalendar', btn_block_allTask, btn_block_newTask, btn_block_appointedTask, btn_block_proccesTask, btn_block_overTask);
            ...
            btn_block_allTask.addEventListener('click', function() {
                this.handleButtonGroupClick('typeAll', btn_block_allTask, btn_block_newTask, btn_block_appointedTask, btn_block_proccesTask, btn_block_overTask);
            ...
            btn_block_newTask.addEventListener('click', function() {
                this.handleButtonGroupClick('typeOrange', btn_block_newTask, btn_block_appointedTask, btn_block_allTask, btn_block_proccesTask, btn_block_overTask);
                if(this.Author == true && this.Executor == false) {
            ...
            btn_block_appointedTask.addEventListener('click', function() {
                this.handleButtonGroupClick('typeBlue', btn_block_appointedTask, btn_block_newTask, btn_block_allTask, btn_block_proccesTask, btn_block_overTask);
                if(this.Author == true && this.Executor == false) {
                    this.Color = '.typeBlue';
                    this.renderBlocks('Author', this.Author)
                }else if(this.Author == false && this.Executor == true) {
            ...
            btn_block_proccesTask.addEventListener('click', function() {
                this.handleButtonGroupClick('typeGreen', btn_block_proccesTask, btn_block_newTask, btn_block_appointedTask, btn_block_allTask, btn_block_overTask);
                if(this.Author == true && this.Executor == false) {
            ...
            btn_block_overTask.addEventListener('click', function() {
                this.handleButtonGroupClick('typeRed', btn_block_overTask, btn_block_newTask, btn_block_appointedTask, btn_block_proccesTask, btn_block_allTask);
                if(this.Author == true && this.Executor == false) {
                    this.Color = '.typeRed';
                    this.renderBlocks('Author', this.Author)
                }else if(this.Author == false && this.Executor == true) {
