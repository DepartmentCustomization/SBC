  ...
  return 
{
        ...
        return `
            <div style="color: cadetblue;    font-size: larger;    text-align: center;     background: #eeeeee;">
            Відкриті Заявки від клієнта чи за вказаним телефоном
            </div>
        `;
    },
...
executeSql: function(message) {
  ...
  //  console.log(data);
       ...
       var divMenuItemBlock2 = document.getElementById('btn_save_data2');
    ...
    //debugger;
                ...
                document.getElementById('btn_save_data2').style.display = '';
