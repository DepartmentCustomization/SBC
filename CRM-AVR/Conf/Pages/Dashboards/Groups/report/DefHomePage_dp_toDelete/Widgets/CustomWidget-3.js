                        ...
                        //   },
                           ...
                           select: function(start, end) {
                               var today = new Date(start._d);
                                ...
                                window.open(location.origin + localStorage.getItem('VirtualPath') + "/sections/Shifts/add/Organizations_WO/19?DefaultValues="+r2, "_self");
