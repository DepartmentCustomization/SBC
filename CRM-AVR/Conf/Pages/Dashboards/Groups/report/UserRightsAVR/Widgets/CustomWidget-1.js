    ...
    return {
        ...
        load_filter: function(data, type) {
            if (this.param_filter == 1) {
                let div = document.getElementById('refresh_group_list');
                let listener = function(event) {
                    this.load_group(1, 1);
                }.bind(this);
                div.addEventListener('click', listener, false);
                // div.removeEventListener('click', listener, false);
                let div2 = document.getElementById('undo_group_list');
        ...
        load: function(data) {
            ...
            if (data) {
                for (let i = 0; i < data.rows.length; i++) {
                    let iDiv = document.getElementById('person_table_id');
                    let iDiv2 = document.createElement('li');
