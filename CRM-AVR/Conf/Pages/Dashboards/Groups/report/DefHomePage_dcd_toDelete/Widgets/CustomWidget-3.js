  ...
  #calendar {
   /* max-width: 900px;
    ...
    position: sticky;
                ...
                .green-label{
                          border-left: 9px solid #53d77f;
                }
                
                .orange-label{
                          border-left: 9px solid #fdbc49;
                }
...
setTimeout(func, 100);
  ...
  console.log(data);
        let arrayOfTypes = ['typeOrange','typeGreen', 'typeRed'];
       ...
       for( let i = 0; i < data.rows.length; i++ ) {
        ...
        //debugger;
           let sub_data = {
                              ...
                              title: data.rows[i].values[16],
                             // textColor: '#ff5e5e',
                              //color: 'rgb(64, 185, 214)',
                              start: data.rows[i].values[9],
                              end: data.rows[i].values[10],
                             // name: 'First Конференція Name',
                              editable: false,
                              allDay: false,
                              url: location.origin + localStorage.getItem('VirtualPath')+'/sections/Claims/edit/'+data.rows[i].values[0],
                              className: data.rows[i].values[17],
                              startEditable: false,
