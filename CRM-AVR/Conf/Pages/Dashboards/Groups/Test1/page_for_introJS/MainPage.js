(function () {
  return {
    ...
    afterViewInit: function(){
        ...
        var dxHeaderRow = document.querySelectorAll('.dx-header-row>td');
        var arr = Array.from(dxHeaderRow);
        ...
        var table_applications = document.getElementById('table_applications');
        var i_table_applications = this.createElement( 'div', { id: 'i_table_applications', className: 'hint material-icons', innerText: 'info' }); 
        ...
        /* GOOGLE MAPS */
        var ggm = document.getElementById('maps_applications');
        var i_ggm = this.createElement( 'div', { id: 'i_ggm', className: 'hint material-icons', innerText: 'info' });
        ...
        var graphics = document.getElementById('chart_schedule_current_status');
        var i_graphics = this.createElement( 'div', { id: 'i_graphics', className: 'hint material-icons', innerText: 'info' });
        ...
        var graphic_chart = document.getElementById('graphic_chart');
