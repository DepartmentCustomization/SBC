  ...
  return {
    ...
    claimsOnMaps: function(data) {
        ...
        for ( let i = 0;  i < data.rows.length; i++){
            ...
            var contentString1 = '<div id="infowindow_marker02' + i.toString() + '" style="display: flex; max-height: 255px; width:100%;">' +
                    '</div>' + 
                    '</div>' +
