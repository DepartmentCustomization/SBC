  ...
  return {
    init: function(){
        ...
        let type_contact = this.form.getControlValue('contact_types_id');
            if(type_contact == 1 || type_contact == 2){ this.details.setVisibility('Group_Jobs', false);}
            if(type_contact == null){ this.form.setControlValue('contact_types_id', {key: 1 , value: 'Абонент фізична особа'});}
